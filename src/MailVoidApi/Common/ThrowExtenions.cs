...
using Ex = System.ExceptionHelper;
namespace System;
...
public static class ThrowExtension
{
    ...
    public static T ThrowIfNull<T>([NotNull] this T? t, string exMessage = "")
    {
        return t == null ? throw new NullReferenceException(exMessage) : t;
    }
