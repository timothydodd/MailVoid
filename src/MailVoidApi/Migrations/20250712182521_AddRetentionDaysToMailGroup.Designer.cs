...
namespace MailVoidApi.Migrations
{
    ...
    [Migration("20250712182521_AddRetentionDaysToMailGroup")]
    partial class AddRetentionDaysToMailGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MailVoidWeb.Data.Models.UserMailRead", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("UserId", "MailId")
                        .IsUnique();

                    b.ToTable("UserMailRead", (string)null);
                });
            ...
            modelBuilder.Entity("MailVoidWeb.MailGroup", b =>
                {
                    ...
                    b.Property<bool>("IsDefaultMailbox")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
            ...
            modelBuilder.Entity("MailVoidWeb.Data.Models.UserMailRead", b =>
                {
                    b.HasOne("MailVoidWeb.Mail", "Mail")
                        .WithMany()
